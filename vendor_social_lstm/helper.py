# Vendored verbatim from quancore/social-lstm (github.com/quancore/social-lstm,
# NO LICENSE FILE in the upstream repo — research prototyping use; revisit before
# public code release).
# Local modification: the three model imports are commented out (only used by
# get_model(), which we don't call; olstm/vlstm variants aren't vendored).
import numpy as np
import torch
...
# from model import SocialModel  # (see header)
# from olstm_model import OLSTMModel  # (see header)
# from vlstm_model import VLSTMModel  # (see header)
